# implementing-malloc-and-free-in-c-for-a-dynamic-memory-allocator-for-c-programs
...
Ensure that you are using a Linux environment and have installed 1) the Linux make utility, 2) The GNU compiler collection (GCC), and 3) The GNU Project Debugger (GDB)
